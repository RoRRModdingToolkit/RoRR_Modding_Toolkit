...
gui.add_imgui(function()
    if ImGui.Begin("RoRR Modding Toolkit") then
        ...
        elseif ImGui.Button("Buff create") then
            local buff = Buff.create("rmt", "testBuff")

            Buff.set_max_stack(buff, 10)
        ...
        elseif ImGui.Button("Apply customBuff") then
            --log.info(Buff.find("rmt-testBuff"))
            Buff.apply(Player.get_client(), Buff.find("rmt-testBuff"), 120.0, 5)
