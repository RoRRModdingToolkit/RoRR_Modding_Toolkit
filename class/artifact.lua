...
Callback_Raw.add("onStep", "RMT-artifact_onStep", artifact_onStep)
Callback_Raw.add("preStep", "RMT-artifact_preStep", artifact_preStep)
Callback_Raw.add("postStep", "RMT-artifact_postStep", artifact_postStep)
Callback_Raw.add("onDirectorPopulateSpawnArrays", "RMT-artifact_onDirectorPopulateSpawnArrays", artifact_onDirectorPopulateSpawnArrays)
Callback_Raw.add("onStageStart", "RMT-artifact_onStageStart", artifact_onStageStart)
Callback_Raw.add("onSecond", "RMT-artifact_onSecond", artifact_onSecond)
Callback_Raw.add("onMinute", "RMT-artifact_onMinute", artifact_onMinute)
Callback_Raw.add("onAttackCreate", "RMT-artifact_onAttackCreate", artifact_onAttackCreate)
Callback_Raw.add("onAttackHit", "RMT-artifact_onAttackHit", artifact_onAttackHit)
Callback_Raw.add("onAttackHandleStart", "RMT-artifact_onAttackHandleStart", artifact_onAttackHandleStart)
Callback_Raw.add("onAttackHandleEnd", "RMT-artifact_onAttackHandleEnd", artifact_onAttackHandleEnd)
Callback_Raw.add("onDamageBlocked", "RMT-artifact_onDamageBlocked", artifact_onDamageBlocked)
Callback_Raw.add("onEnemyInit", "RMT-artifact_onEnemyInit", artifact_onEnemyInit)
Callback_Raw.add("onEliteInit", "RMT-artifact_onEliteInit", artifact_onEliteInit)
Callback_Raw.add("onDeath", "RMT-artifact_onDeath", artifact_onDeath)
Callback_Raw.add("onPlayerInit", "RMT-artifact_onPlayerInit", artifact_onPlayerInit)
Callback_Raw.add("onPlayerStep", "RMT-artifact_onPlayerStep", artifact_onPlayerStep)
Callback_Raw.add("prePlayerHUDDraw", "RMT-artifact_prePlayerHUDDraw", artifact_prePlayerHUDDraw)
Callback_Raw.add("onPlayerHUDDraw", "RMT-artifact_onPlayerHUDDraw", artifact_onPlayerHUDDraw)
Callback_Raw.add("onPlayerInventoryUpdate", "RMT-artifact_onPlayerInventoryUpdate", artifact_onPlayerInventoryUpdate)
-- Callback_Raw.add("onPlayerDeath", "RMT-artifact_onPlayerDeath", artifact_onPlayerDeath)
Callback_Raw.add("onCheckpointRespawn", "RMT-artifact_onCheckpointRespawn", artifact_onCheckpointRespawn)
Callback_Raw.add("onPickupCollected", "RMT-artifact_onPickupCollected", artifact_onPickupCollected)
Callback_Raw.add("onPickupRoll", "RMT-artifact_onPickupRoll", artifact_onPickupRoll)
Callback_Raw.add("onEquipmentUse", "RMT-artifact_onEquipmentUse", artifact_onEquipmentUse)
Callback_Raw.add("postEquipmentUse", "RMT-artifact_postEquipmentUse", artifact_postEquipmentUse)
Callback_Raw.add("onInteractableActivate", "RMT-artifact_onInteractableActivate", artifact_onInteractableActivate)
Callback_Raw.add("onHitProc", "RMT-artifact_onHitProc", artifact_onHitProc)
Callback_Raw.add("onDamagedProc", "RMT-artifact_onDamagedProc", artifact_onDamagedProc)
Callback_Raw.add("onKillProc", "RMT-artifact_onKillProc", artifact_onKillProc)
